												...
												<div class="btn-group">
													<?php if ($data->status < 5) : ?>
														...
														<?php if ($data->status != 4) : ?>
															...
															<?php endif ?>
															<?php if ($data->isi_laporan != null || $data->isi_laporan != '') : ?>
																<a href="<?= site_url('spdku/laporan/pelaksanaan_st/' . $data->id) ?>" target="_blank" class="btn btn-sm bg-pink" data-toggle="tooltip" data-placement="top" title="Laporan Pelaksanaan ST">
																	<i class="fa fa-file-signature"></i>
																</a>
															<?php endif ?>
															<?php if ($data->kuitansi != null || $data->kuitansi != '') : ?>
																<!--<a href="<?= site_url('uploads/kuitansi/' . $data->kuitansi) ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Kuitansi">
