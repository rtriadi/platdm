<?php if ($gaji->num_rows() > 0) : ?>
	...
	<table class="" width="85%" align="center" style="font-size: 12px;">
		<tr align="center">
			<td width="5%"><img src="<?= site_url() ?>assets/img/logo.png" class="img img-responsive mt-3" width="130"></td>
			<td>
				<p style="font-weight: bold;">KEMENTERIAN KEUANGAN REPUBLIK INDONESIA <br>
					DIREKTORAT JENDERAL PAJAK <br>
					KANTOR WILAYAH DJP SULAWESI UTARA, TENGAH, GORONTALO DAN MALUKU UTARA <br>
					KANTOR PELAYANAN PAJAK PRATAMA GORONTALO</p>
				<p style="font-size: 9px; font-weight: bold;">JALAN ARIF RAHMAN HAKIM NO.34, GORONTALO, <br>
					TELEPON (0435) 830010, FAKSIMILE (0435) 830009, WEBSITE : www.pajak.go.id</p>
			</td>
		</tr>
	</table>
	<hr style="border: 1px solid black;" width="85%" style="font-size: 10px; font-weight: bold;">
	<table class="" width="85%" align="center">
		<tr align="center">
			<td>
				<p><b>RINCIAN PENGHASILAN <br>
						BULAN <?= strtoupper($bln) ?><br>
						TAHUN <?= $thn ?></b></p>
			</td>
		</tr>
	</table>

	<table class="" border="0px" width="85%" align="center" style="font-size: 12px;">
		<tr>
			<td colspan="5"><b>NAMA</b></td>
			<td width="1%"><b>:</b> </td>
			<td width="30%"><b><?= strtoupper($gaji->row()->nama) ?></b></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" width="1%" align="center">I. </td>
		...
		<tr>
			<td colspan="3"></td>
			<td></td>
			<td width="30%">Jumlah Potongan</td>
			<td>: </td>
